            ...
            <Col md="12">
                ...
                <Table dark={_mode === "dark" ? true : false} bordered hover >
                    <thead className='text-center'>
                        <tr>
                            <th>#</th>
                            <th><Translate content="dashboard.function.inputs.args.name"/></th>
                            { props.args?.length > 0 && <th>Actions</th>}
                        </tr>
                    </thead>
                    <tbody className='text-center'>
                        {
                            ...
                            ? <tr>
                                <td colSpan="3">
                                    <Translate content="dashboard.function.inputs.args.noArgs" />
                                </td>
                            </tr>
                                    ...
                                    { props.args?.length > 0 && 
                                        <td>
                                            <div style={{ display: 'flex', justifyContent: "center" }}>
                                                <div onClick={() => props.editArg(index)} style={{ marginRight: '5px' }}>
                                                    <EditIcon className="whiteIcon" />
                                                </div>
                                                <div onClick={() => props.deleteArg(index)}>
