            ...
            <Col md="12">
                <div style={{ background: _mode === "dark" ? "#2C3139" : "#0861AF", padding: "10px", color: "#fff", display: "flex", justifyContent: "space-between", alignItems: "center", borderTopLeftRadius: "10px", borderTopRightRadius: "10px"  }}>
                    ...
                    <Tooltip title={context.counterpart('common.button.add')}>
                        <div onClick={() => props.addNewSubdomain()}>
                ...
                <Table dark={_mode === "dark" ? true : false} bordered hover >
                    <thead className='text-center'>
                        <tr>
                            <th>#</th>
                            <th><Translate content="dashboard.addEnvironement.inputs.subdomains.title"/></th>
                            { props.subdomains?.length > 0 && <th>Actions</th>}
                        </tr>
                    </thead>
                    <tbody className='text-center'>
                        {
                            ...
                            ? <tr>
                                <td colSpan="3">
                                    <Translate content="dashboard.addEnvironement.inputs.subdomains.noSubdomains" />
                                </td>
                            </tr>
                                    ...
                                    { props.subdomains?.length > 0 && 
                                        <td>
                                            <div style={{ display: 'flex', justifyContent: "center" }}>
                                                <div onClick={() => props.editSubdomain(index)} style={{ marginRight: '5px' }}>
                                                    <EditIcon className="whiteIcon" />
                                                </div>
                                                <div onClick={() => props.deleteSubdomain(index)}>
