...
const ResourceItem = (props) => {
    ...
    if (props.loading)
        return (
            <Col xs='4' md='3' className={classes.loadingMainContainer} onClick={props.onClick} style={{backgroundColor: colors.secondBackground[_mode], border: '1px solid '+ colors.border[_mode]}}>
