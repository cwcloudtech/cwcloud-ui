...
import classes from "./AdminFunctionsPage.module.css";
...
function AdminFunctionsPage(props) {
    ...
    const columns = [
        { field: 'id', headerName: context.counterpart("dashboard.table.id"), width: 340, renderCell: (params) => (<Link to={`/admin/function/${params.id}`}>{params.id}</Link>) },
        ...
        { field: 'actions', headerName: context.counterpart("dashboard.table.actions"), width: 130, renderCell: (params) => {
                ...
                return (
                    <React.Fragment>
                        ...
                        &nbsp;
                        <Link to={`/admin/schedule/${params.id}`}>
        ...
        { field: 'owner', headerName: context.counterpart("dashboard.table.owner"), width: 200, renderCell: (params) => (params.row.owner.username ? params.row.owner.username : "not known") },
    ...
    useEffect(() => {
        ...
        axios.get("/admin/faas/functions")
            .then(res => {
                    ...
                    <div style={{ paddingBottom: "20px"  }} className={classes.envCreation}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <Tooltip TransitionComponent={Fade} TransitionProps={{ timeout: 600 }} title={<h5 className={classes.tootltipValue}>
                                ...
                                <Fab color="primary" aria-label="add" onClick={() => navigate("/admin/function/add")} style={{ transform: 'scale(0.7)' }} >
