...
import classes from "./AdminAttachInstance.module.css"
...
function AdminAttachInstance(props) {
    ...
    const attachInstanceHandler = () => {
        setLoading(true)
        axios.post(`/admin/instance/${context.selectedProvider.name}/${context.region.name}/${zone}/attach/${project.id}`, { ...instanceInfo })
            .then(response => {
                setLoading(false)
            ...
            <CardComponent
                ...
                <FormControl sx={{ m: 1, width: 300 }}>
                    <InputLabel id="demo-multiple-name-label">
                        <Translate content="dashboard.attachInstance.inputs.playbook.project" />
                    </InputLabel>
                    <Select
...
export default AdminAttachInstance;
