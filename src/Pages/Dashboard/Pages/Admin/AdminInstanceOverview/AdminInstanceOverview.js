...
import classes from "./AdminInstanceOverview.module.css";
...
function AdminInstanceOverview() {
    ...
    const onDeleteHandler = () => {
        setloadingRequest(true)
        axios.delete(`/admin/instance/${instance.id}`).then(response => {
    ...
    const fetchInstance = () => {
        axios.get(`/admin/instance/${instanceId}`)
            .then(res => {
                        ...
                        <Col xs="12" md="12" className={classes.row}>
                            <Row>
                                ...
                                <Col className={classes.colinline} xs="auto" md="auto">
                                    ...
                                    {!loading ? <Link to={`/admin/project/${instance.project.id}`}>
...
export default AdminInstanceOverview