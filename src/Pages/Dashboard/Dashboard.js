                ...
                <Column flexGrow={1} className={classes.mainBlock}>
                    ...
                    <div className={classes.contentBlock}>
                        <Routes>
                            ...
                            <Route exact path="/invoke/overview" element={<InvocationsPage />} />
                            <Route exact path="/triggers/overview" element={<TriggersPage />} />
                            <Route exact path="/schedule/:id" element={<AddCronFunction />} />
                            <Route exact path="/admin/schedule/:id" element={<AddCronFunction />} />
                            <Route exact path="/admin/function" element={<AdminFunctionsPage />} />
                            ...
                            <Route exact path="/admin/invoke" element={<AdminInvocationsPage />} />
